...
(setq awesome-javascript-packages
      '(
...
(defun awesome-javascript/init-company-tern ()
...
(defun awesome-javascript/init-rjsx-mode ()
...
(defun awesome-javascript/post-init-evil-matchit ()
  (add-hook `js2-mode `turn-on-evil-matchit-mode))

(defun awesome-javascript/init-js2-refactor ()
...
(defun awesome-javascript/init-json-mode ()
  (use-package json-mode
    :defer t))

(defun awesome-javascript/init-json-snatcher ()
...
(defun awesome-javascript/init-tern ()
  (use-package tern
    :defer t
...
(defun awesome-javascript/init-web-beautify ()
...
(defun awesome-javascript/init-skewer-mode ()
...
(defun awesome-javascript/init-livid-mode ()
